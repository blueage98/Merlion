...
def create_control_panel() -> html.Div:
    return html.Div(
        ...
        children=[
            ...
            html.Br(),
            html.P("Uploaded File"),
            dcc.Dropdown(id="select-file", options=[], placeholder="Select...", style={"width": "100%"}),
            html.Br(),
            html.P("Sample Data"),
            html.Div(
                id="select-sample-file-parent",
                children=[dcc.Dropdown(id="select-sample-file", options=[], style={"width": "100%"})],
            ),
            html.Br(),
